...
### Additional label for visualisation 2
...
A similar code is used to construct visualisation 2 as visualisation 1. The only change is that share of points will be used for the y axis instead of points. 
